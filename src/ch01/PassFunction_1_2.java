...
public class PassFunction_1_2 {
    ...
    public static void main(String[] args) {
        ...
        List<Apple> greenApples = filterApples(apples,PassFunction_1_2::isGreenApple);
        for(Apple apple:greenApples) {
            System.out.println(apple.color);
        }

        List<Apple> heavyApples = filterApples(apples,PassFunction_1_2::isHeavyWeight);
